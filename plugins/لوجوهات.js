let handler = async (m, { conn, args, text, usedPrefix, command }) => {
        let tee = `✳️ اضف نص\n\n📌 مثال  : *${usedPrefix + command}* 𝙼𝚅𝚁𝙾-𝙱𝙾𝚃`
        let too = `✳️ افصل الكلمه بـ *+* \n\n📌 مثـال : \n*${usedPrefix + command}* 𝙼𝚅𝚁𝙾 *+* BOT`
  ...
  handler.help = ['تصميم1', 'تصميم2', 'تصميم3', 'تصميم4', 'تصميم5', 'تصميم6', 'تصميم7', 'تصميم8', 'تصميم9', 'تصميم10', 'تصميم11', 'تصميم12'];
  handler.tags = ['maker'];
