...
if (Config.WORKTYPE == 'private') {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '❤️𝐌𝐀𝐃𝐄 𝐁𝐘 𝑮𝑶𝑲𝑼 𝐁𝐎𝐓💙'})

    }));
}
else if (Config.WORKTYPE == 'public') {

    Asena.addCommand({pattern: 'anime', fromMe: false, desc:'صوره انمي عشوائية 🔀'}, (async (message, match) => {
    ...
    await message.sendMessage(Buffer(respoimage.data), MessageType.image, {mimetype: Mimetype.png, caption: '❤️𝐌𝐀𝐃𝐄 𝐁𝐘 𝑨𝑴𝑹𝑶 𝑲𝑯𝑨𝑳𝑰𝑫🇾🇪♥🇵🇸💙'})
